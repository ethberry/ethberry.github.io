...
<Config config={linearVestingConfig} />
...
<Config config={linearCliffVestingConfig} />
...
<Config config={linearImmediateUnlockConfig} />
...
<Config config={linearCliffUnlockConfig} />
...
<Config config={exponentialVestingConfig} />
...
<Config config={exponentialCliffVestingConfig} />
...
<Config config={exponentialCliffUnlockConfig} />
...
<Config config={exponentialImmediateUnlockConfig} />
...
<Config config={hyperbolicVestingConfig} />
...
<Config config={hyperbolicCliffVestingConfig} />
...
<Config config={hyperbolicImmediateUnlockConfig} />
...
<Config config={hyperbolicCliffUnlockConfig} />
...
<Config config={monthlyLinearConfig} />
...
<Config config={monthlyExponentialConfig} />
...
<Config config={monthlyHyperbolicConfig} />
