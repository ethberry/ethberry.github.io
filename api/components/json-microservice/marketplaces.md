...
Here is an example of metadata for [RANDOM](/docs/integrations/chain-link/), [UPGRADABLE](/docs/admin-panel/simple-mechanics/grade/) [ERC998](/docs/category/erc998/) token
